...
export default function ChatbotHomePage({ searchParams }) {
  return <ChatbotClient embedded={false} model={parseModel(searchParams)} backgroundColor={parseBackgroundColor(searchParams)} />;
}
